...
-(id)keyWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
-(id)stringFromArray:(id)arg1 ;
-(id)arrayWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
...
-(id)boolWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
-(id)stringLiteralWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
-(id)objectWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
-(id)stringFromNull:(id)arg1 ;
-(id)numberWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
-(id)dictionaryWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
-(id)nullWithReaderInfo:(SCD_Struct_GE169*)arg1 ;
@end
