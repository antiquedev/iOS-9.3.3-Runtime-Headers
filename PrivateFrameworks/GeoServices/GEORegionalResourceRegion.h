...
@property (nonatomic,readonly) SCD_Struct_GE87* tileRanges; 
...
-(SCD_Struct_GE87)tileRangeAtIndex:(unsigned long long)arg1 ;
-(SCD_Struct_GE87*)tileRanges;
-(void)setTileRanges:(SCD_Struct_GE87*)arg1 count:(unsigned long long)arg2 ;
-(void)clearTileRanges;
-(void)addTileRange:(SCD_Struct_GE87)arg1 ;
@end
