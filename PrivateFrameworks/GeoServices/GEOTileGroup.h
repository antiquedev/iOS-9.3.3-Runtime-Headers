...
@property (nonatomic,readonly) SCD_Struct_GE104* tileSets; 
...
@property (nonatomic,readonly) SCD_Struct_GE103* regionalResourceIndexs; 
...
@property (nonatomic,readonly) SCD_Struct_GE87* hybridUnavailableRegions; 
-(void)dealloc;
...
-(void)addTileSet:(SCD_Struct_GE104)arg1 ;
-(SCD_Struct_GE104)tileSetAtIndex:(unsigned long long)arg1 ;
-(SCD_Struct_GE104*)tileSets;
-(void)clearTileSets;
-(void)clearFontIndexs;
-(unsigned*)textureIndexs;
-(void)addRegionalResourceIndex:(SCD_Struct_GE103)arg1 ;
...
-(void)setRegionalResourceIndexs:(SCD_Struct_GE103*)arg1 count:(unsigned long long)arg2 ;
-(unsigned)fontIndexAtIndex:(unsigned long long)arg1 ;
-(void)clearXmlIndexs;
-(void)addStyleSheetIndex:(unsigned)arg1 ;
-(SCD_Struct_GE87*)hybridUnavailableRegions;
-(SCD_Struct_GE103)regionalResourceIndexAtIndex:(unsigned long long)arg1 ;
...
-(SCD_Struct_GE87)hybridUnavailableRegionAtIndex:(unsigned long long)arg1 ;
-(void)setTileSets:(SCD_Struct_GE104*)arg1 count:(unsigned long long)arg2 ;
...
-(unsigned*)iconIndexs;
-(void)addHybridUnavailableRegion:(SCD_Struct_GE87)arg1 ;
...
-(void)setHybridUnavailableRegions:(SCD_Struct_GE87*)arg1 count:(unsigned long long)arg2 ;
-(SCD_Struct_GE103*)regionalResourceIndexs;
