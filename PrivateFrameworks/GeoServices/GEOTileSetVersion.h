...
@property (nonatomic,readonly) SCD_Struct_GE87* availableTiles; 
...
@property (nonatomic,readonly) SCD_Struct_GE88* genericTiles; 
...
-(SCD_Struct_GE87*)availableTiles;
...
-(SCD_Struct_GE88*)genericTiles;
-(unsigned)supportedLanguagesVersion;
-(void)setAvailableTiles:(SCD_Struct_GE87*)arg1 count:(unsigned long long)arg2 ;
-(void)setGenericTiles:(SCD_Struct_GE88*)arg1 count:(unsigned long long)arg2 ;
-(BOOL)hasTimeToLiveSeconds;
-(unsigned long long)availableTilesCount;
-(SCD_Struct_GE88)genericTileAtIndex:(unsigned long long)arg1 ;
-(SCD_Struct_GE87)availableTilesAtIndex:(unsigned long long)arg1 ;
-(unsigned long long)genericTilesCount;
-(BOOL)hasSupportedLanguagesVersion;
-(void)addGenericTile:(SCD_Struct_GE88)arg1 ;
-(void)setHasTimeToLiveSeconds:(BOOL)arg1 ;
-(void)addAvailableTiles:(SCD_Struct_GE87)arg1 ;
