...
@property (nonatomic,readonly) SCD_Struct_GE88* tileUsages; 
...
-(void)addTileUsage:(SCD_Struct_GE88)arg1 ;
...
-(void)setTileUsages:(SCD_Struct_GE88*)arg1 count:(unsigned long long)arg2 ;
-(void)setHasSessionIDIsPersistent:(BOOL)arg1 ;
-(void)setHasResponseTime:(BOOL)arg1 ;
-(BOOL)hasResponseTime;
-(SCD_Struct_GE88)tileUsageAtIndex:(unsigned long long)arg1 ;
