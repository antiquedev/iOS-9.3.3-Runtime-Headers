...
-(SCD_Struct_GE177)_updateParamsForStepProgression:(const SCD_Struct_GE177*)arg1 trackedLocation:(id)arg2 minNumMatchesToAdvanceStep:(unsigned long long)arg3 minDistanceAlongStepToAdvance:(double)arg4 ;
