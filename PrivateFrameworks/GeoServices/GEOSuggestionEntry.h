...
@interface GEOSuggestionEntry : PBCodable <NSCopying> {
	...
	SCD_Struct_GE224* _textHighlights;
...
@property (nonatomic,readonly) SCD_Struct_GE224* textHighlights; 
...
-(NSString *)iconID;
-(SCD_Struct_GE224*)textHighlights;
-(BOOL)hasIconID;
-(void)setIconID:(NSString *)arg1 ;
-(SCD_Struct_GE224)textHighlightsAtIndex:(unsigned long long)arg1 ;
-(void)setTextHighlights:(SCD_Struct_GE224*)arg1 count:(unsigned long long)arg2 ;
...
-(void)addTextHighlights:(SCD_Struct_GE224)arg1 ;
@end
