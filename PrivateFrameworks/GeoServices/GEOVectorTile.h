...
@interface GEOVectorTile : NSObject {
	...
	SCD_Struct_GE97* _polygonLabelPositions;
	...
	SCD_Struct_GE104* _transitLinkLineKeys;
	...
	SCD_Struct_GE97* _transitLinkSections;
...
@property (nonatomic,readonly) SCD_Struct_GE98* pois;                                              //@synthesize pois=_pois - In the implementation block
...
@property (nonatomic,readonly) const SCD_Struct_GE97* transitLinkSections;                         //@synthesize transitLinkSections=_transitLinkSections - In the implementation block
...
-(BOOL)_readInfoChapter:(SCD_Struct_GE168*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_readPolygons:(SCD_Struct_GE168*)arg1 ofType:(unsigned short)arg2 ;
-(BOOL)_readPois:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_decodeTransitLabelsFromStream:(SCD_Struct_GE169*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE96*)arg3 featureStride:(unsigned long long)arg4 ;
-(BOOL)_readTransitSystemsChapterIDSet:(SCD_Struct_GE169*)arg1 featureCount:(unsigned long long)arg2 handler:(/*^block*/id)arg3 ;
-(unsigned long long)_makeSpaceForLabels:(unsigned long long)arg1 ;
-(BOOL)_readTransitSystems:(SCD_Struct_GE168*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_readCoverage:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_readTileReferences:(SCD_Struct_GE168*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_addGenericPolygonWithAttributes:(int*)arg1 ;
-(BOOL)_readExtendedPointAttributes:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_readTransitSystemsChapterLabelSet:(SCD_Struct_GE169*)arg1 featureCount:(unsigned long long)arg2 handler:(/*^block*/id)arg3 ;
-(BOOL)_readHighResBuildings:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_readLowResBuildings:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_readCoastlines:(SCD_Struct_GE168*)arg1 ;
-(id)_initWithVMP4:(id)arg1 localizationData:(id)arg2 tileKey:(const GEOTileKey*)arg3 ;
-(BOOL)_readModernBuildings:(SCD_Struct_GE168*)arg1 chapter:(unsigned short)arg2 vertexPool:(/*function pointer*/void**)arg3 footprints:(/*function pointer*/void**)arg4 count:(unsigned long long*)arg5 ;
-(BOOL)_decodeLabelTextPlacementsFromStream:(SCD_Struct_GE169*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE98*)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5 ;
-(BOOL)_populateTransitNodeStyleAttributes;
-(id)addAttributes:(id)arg1 toUniqueAttributeSet:(id)arg2 ;
-(BOOL)_readLabels:(SCD_Struct_GE168*)arg1 ;
-(unsigned long long)_makeSpaceForShields:(unsigned long long)arg1 ;
-(BOOL)_readLines:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_readTransitNetwork:(SCD_Struct_GE168*)arg1 key:(const GEOTileKey*)arg2 ;
-(BOOL)_readLabelAnnotations:(SCD_Struct_GE168*)arg1 key:(const GEOTileKey*)arg2 forLines:(BOOL)arg3 ;
-(BOOL)_readTransitMZROverride:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_handleGenericTile:(SCD_Struct_GE168*)arg1 ;
...
-(BOOL)_readPolygons:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_read3DBuildings:(SCD_Struct_GE168*)arg1 ;
-(BOOL)_readWrappingCoastlines:(SCD_Struct_GE170*)arg1 tile:(SCD_Struct_GE168*)arg2 ;
-(BOOL)_readSimpleCoastlines:(SCD_Struct_GE170*)arg1 tile:(SCD_Struct_GE168*)arg2 ;
-(BOOL)_findJunctions;
...
-(SCD_Struct_GE97*)polygonLabelPositions;
...
-(const SCD_Struct_GE97*)transitLinkSections;
...
-(void)forEachEdgeInRoad:(SCD_Struct_GE113*)arg1 visitTwice:(BOOL)arg2 visitor:(/*^block*/id)arg3 ;
