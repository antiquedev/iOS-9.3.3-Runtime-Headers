...
@class NSString, NSDate, NSDictionary, NSURL, NSNumber, NSSet, PKNFCPayload, PKImage, PKPaymentPass, UIImage, PKPassDisplayProfile, PKBarcode, NSArray, PKPassPersonalization;
