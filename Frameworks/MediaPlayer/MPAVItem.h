...
@class AVAsset, NSObject, AVPlayerItem, MPQueueFeeder, MPAVController, NSArray, MPAlternateTracks, NSError, NSString, MPMediaItem, MPStoreDownload, AVPlayerItemAccessLog, NSURL, MPAlternateTextTrack;
