...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI55 _previousPoint;
...
@property (assign,nonatomic) SCD_Struct_UI66 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI66)arg1 ;
-(BOOL)initialPointPosted;
-(SCD_Struct_UI66)previousPoint;
