...
@class _UICascadingTextStorage, UIImage, UIView, UITextInputTraits, UIButton, UITextFieldBorderView, UITextFieldBackgroundView, _UIFloatingContentView, UIVisualEffectView, _UIDetachedFieldEditorBackgroundView, UITextFieldLabel, UIImageView, UILabel, UITextInteractionAssistant, UITapGestureRecognizer, UISystemInputViewController, UITextFieldAtomBackgroundView, NSLayoutConstraint, _UIBaselineLayoutStrut, UIColor, NSString, NSAttributedString, UIFont, NSDictionary, NSIndexSet, UITextRange, UITextPosition;
