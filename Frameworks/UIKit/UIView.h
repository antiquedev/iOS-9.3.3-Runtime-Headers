...
@class UIBezierPath, UITraitCollection, NSMutableArray, CALayer, NSArray, UIViewController, NSString, UIColor, UILayoutGuide, NSISVariable, NSISEngine, UIPresentationController, UIStoryboardPreviewingSegueTemplateStorage, UIKBRenderConfig, _UITouchForceObservable, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSLayoutDimension;

@interface UIView : UIResponder <NSISEngineDelegate, NSISVariableDelegate, _UILayoutItem, UITextEffectsOrdering, _UIScrollNotification, _UITraitEnvironmentInternal, _UIFocusEnvironmentInternal, NSCoding, UIAppearance, UIAppearanceContainer, UIDynamicItem, UITraitEnvironment, UICoordinateSpace, UIFocusEnvironment> {
