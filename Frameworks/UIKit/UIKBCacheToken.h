...
@property (assign,nonatomic) SCD_Struct_UI36 styling; 
...
+(id)tokenForKey:(id)arg1 style:(SCD_Struct_UI36)arg2 ;
+(id)tokenForKeyMask:(id)arg1 style:(SCD_Struct_UI36)arg2 displayInsets:(UIEdgeInsets)arg3 ;
...
-(SCD_Struct_UI36)styling;
-(void)setStyling:(SCD_Struct_UI36)arg1 ;
-(int)emptyFields;
-(BOOL)hasKey;
