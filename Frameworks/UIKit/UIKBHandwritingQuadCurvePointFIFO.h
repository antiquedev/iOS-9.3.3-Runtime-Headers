...
@property (assign,nonatomic) SCD_Struct_UI66 lastPoint;                //@synthesize lastPoint=_lastPoint - In the implementation block
-(void)dealloc;
-(void)flush;
...
-(void)setLastPoint:(SCD_Struct_UI66)arg1 ;
-(SCD_Struct_UI66)lastPoint;
-(id)emissionHandler;
@end
