...
-(CGRect)handwritingPointToRect:(SCD_Struct_UI66)arg1 ;
...
-(void)addTrapezoidFromFirstPoint:(SCD_Struct_UI66)arg1 secondPoint:(SCD_Struct_UI66)arg2 ;
-(void)addHandwritingPoint:(SCD_Struct_UI66)arg1 ;
