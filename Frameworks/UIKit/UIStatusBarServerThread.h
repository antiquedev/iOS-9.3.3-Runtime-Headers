...
@interface UIStatusBarServerThread : NSThread {
	...
	SCD_Struct_UI73 _statusBarData;
	SCD_Struct_UI73 _composedStatusBarData;
	SCD_Struct_UI74 _overrides;
...
-(void)_postStatusBarData:(SCD_Struct_UI73*)arg1 actions:(int)arg2 ;
