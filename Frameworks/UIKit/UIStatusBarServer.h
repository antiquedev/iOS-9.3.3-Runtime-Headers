...
+(void)postStatusBarData:(const SCD_Struct_UI73*)arg1 withActions:(int)arg2 ;
+(void)postStatusBarOverrideData:(SCD_Struct_UI74*)arg1 ;
+(void)permanentizeStatusBarOverrideData;
+(const SCD_Struct_UI73*)getStatusBarData;
...
-(void)_receivedStatusBarData:(SCD_Struct_UI73*)arg1 actions:(int)arg2 ;
